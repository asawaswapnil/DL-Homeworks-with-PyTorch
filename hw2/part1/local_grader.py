...
def test_cnn_correctness_once(idx):
    ...
    #############################################################################################
    y = net(x)
    # print(y.shape,y, y1.shape,y1)
    # print(type(y))

    # print('y:', y)np.allclose
    # print('y1:', y1)
    ...
    # print("shapes",net.dW.shape,model.weight.grad.detach().numpy().shape )
    ...
    # print("dW",net.dx1),
    # print("dW_res", model.weight.grad.detach().numpy())
...
def test_part_b():
    ...
    # print("shapes",result.shape,expected_result.shape)
    try:
