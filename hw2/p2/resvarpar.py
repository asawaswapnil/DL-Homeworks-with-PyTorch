...
def test_varify(model,var_loader1, var_loader2):
    ...
    print(device)
    o1=np.zeros((899965,2300))
    o2=np.zeros((899965,2300))
    o1=torch.from_numpy(o1).float().to(device)
    o2=torch.from_numpy(o2).float().to(device)
    o2=o2.cpu().numpy()
    o1=o1.cpu().numpy()
    f = open('o1.pckl', 'wb')
    pickle.dump(o1, f)
